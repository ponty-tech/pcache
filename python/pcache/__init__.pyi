...
class UserInfoBackendProtocol(Protocol):
    async def fetch(self, account_id: str) -> dict[str, Any] | None: ...

class CollectionBackendProtocol(Protocol):
...
class UserInfoCache:
    ...
    async def create(
        cls,
        redis_url: str,
        backend: UserInfoBackendProtocol,
        config: CacheConfig,
        redis_key_prefix: str,
        redis_key_suffix: str,
        invalidation_channel: str,
    ) -> "UserInfoCache": ...
    async def get(self, account_id: str) -> UserInfo | None: ...
...
class CollectionCache:
    ...
    async def create(
        cls,
        redis_url: str,
        backend: CollectionBackendProtocol,
        config: CacheConfig,
        redis_key: str,
        invalidation_channel: str,
    ) -> "CollectionCache": ...
